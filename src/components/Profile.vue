          ...
          <div class="col-lg-8">
            ...
            >
              ...
              >
                ...
                <p v-if="userData.birthday">
                  <strong>Date of Birth:</strong> {{ new Date(userData.birthday).toLocaleDateString() }}
                </p>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  >
                    ...
                    <p v-if="billingAddress.countryState">
                      <strong>State:</strong> {{ billingAddress.countryState.name }}
                    </p>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <p v-if="shippingAddress.countryState">
                      <strong>State:</strong> {{ shippingAddress.countryState.name
                      }}
                    </p>
                  </div>
                </div>
